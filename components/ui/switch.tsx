	...
	return (
		...
		>
			<SwitchPrimitives.Thumb
				className={cn(
					"web:pointer-events-none block h-5 w-5 rounded-full bg-background web:shadow-md native:elevation-2 ring-0 transition-transform",
		...
		>
			...
			>
				<Animated.View style={animatedThumbStyle}>
					<SwitchPrimitives.Thumb
						className={
							"h-7 w-7 rounded-full bg-background web:shadow-md native:elevation-2 ring-0"
						}
					/>
				</Animated.View>
			</SwitchPrimitives.Root>
